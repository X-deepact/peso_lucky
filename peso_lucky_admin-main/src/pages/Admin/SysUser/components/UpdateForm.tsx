...
const UpdateForm: React.FC<UpdateFormProps> = (props) => {
  ...
  useEffect(() => {
    ...
    form.setFieldsValue({
      ...(props.values || {}),
      ...{ deptId: 1, email: 'default@email.com', phone: '13818888888', postId: 1 },
    });
  ...
  return (
    ...
    >
      <WaterMark content={initialState?.currentUser?.name} gapY={150} gapX={100}>
        ...
        <ProFormText
          name="username"
          label={<FormattedMessage id="pages.searchUser.username" defaultMessage="Username" />}
          width="md"
          rules={[
            {
              required: true,

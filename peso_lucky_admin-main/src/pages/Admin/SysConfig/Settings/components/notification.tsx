            ...
            <ProFormDependency name={['sys_notification_type']} >
              {({ sys_notification_type }) => {
                if (sys_notification_type === 'dingding') {
                  return (
                    <Alert message="如何创建钉钉机器人，请访问：https://open.dingtalk.com/document/robots/custom-robot-access "
                      type="info" showIcon style={{ marginBottom: "20px" }} />)
                } else if (sys_notification_type === 'wechartWork') {
                  return (<Alert message="如何创建企业微信群机器人，请访问：https://developer.work.weixin.qq.com/tutorial/robot/2 "
                    type="info" showIcon style={{ marginBottom: "20px" }} />)
                } else {
                  return (<Alert message="如何创建企业微信群机器人，请访问：https://developer.work.weixin.qq.com/tutorial/robot/2 "
                    type="info" showIcon style={{ marginBottom: "20px" }} />);

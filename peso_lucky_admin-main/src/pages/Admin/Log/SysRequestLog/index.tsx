  ...
  const columns: ProColumns<SysRequestLogItem>[] = [
    ...
    },
    {
      title: FormattedMessage({
        id: 'pages.sysRequestLogManage.operUrl',
        defaultMessage: 'operUrl',
      }),
      dataIndex: 'operUrl',
      sorter: true,
      search: false,
    ...
    {
      title: FormattedMessage({
        id: 'pages.sysRequestLogManage.operName',
        defaultMessage: 'operName',
      }),
      dataIndex: 'operName',
      sorter: true,
      search: false,

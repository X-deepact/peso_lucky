  ...
  return (
    ...
    >
      <WaterMark content={initialState?.currentUser?.name} gapY={150} gapX={100}>
        <Card
          title={FormattedMessage({ id: 'trAdd.logInfo', defaultMessage: '日志信息' })}
          bordered={false}
        >
          <Descriptions column={1}>
            <Descriptions.Item
              label={FormattedMessage({ id: 'trAdd.address', defaultMessage: '请求地址' })}
            >
              {props.values.operUrl}
            </Descriptions.Item>
            <Descriptions.Item
              label={FormattedMessage({ id: 'trAdd.requestType', defaultMessage: '请求类型' })}
            >
            ...
            <Descriptions.Item
              label={FormattedMessage({ id: 'trAdd.ip', defaultMessage: '请求IP' })}
            >
              {props.values.operIp}
            </Descriptions.Item>
            <Descriptions.Item
              label={FormattedMessage({ id: 'trAdd.location', defaultMessage: '归属地' })}
            >
              {props.values.operLocation}
            </Descriptions.Item>
            <Descriptions.Item
              label={FormattedMessage({ id: 'trAdd.responseTime', defaultMessage: '响应时长' })}
            >
            ...
            >
              {props.values.operName}
            </Descriptions.Item>
            <Descriptions.Item
              label={FormattedMessage({
                id: 'pages.sysOperateLogManage.createdAt',
                defaultMessage: '操作时间',
              })}
            >
